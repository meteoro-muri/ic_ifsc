...
#data_aux=`date -u --date="${ai}${mi}${di}" +%Y%m%d%H`;# Linux
#echo ${data_aux}
#exit
#for (( i = 0; i <= $ndays; i++ ))
#do
#	data=`date -u --date="${ai}${mi}${di} + $i days" +%Y%m%d%H`;# Linux
#	echo ${data}
#	af_aux=`echo $data | awk '{ print substr($1,1,4)}'`
#	mf_aux=`echo $data | awk '{ print substr($1,5,2)}'`
#	monf_aux=${mt[`echo $mf_aux | awk '{ print $1*1}'`]}
#	df_aux=`echo $data | awk '{ print substr($1,7,2)}'`
#	hf_aux=`echo $data | awk '{ print substr($1,9,2)}'`
#done
#exit
...
do
	...
	##itera dia a dia pra pegar todas as previs�es de todos os dias##
	...
	arq_7d_gfs=${path_gfs}/${a_aux}${m_aux}/${a_aux}${m_aux}${d_aux}/gfs.t${h_aux}z.pgrb2.0p50.${a_aux}${m_aux}${d_aux}${h_aux}.f001_f120.nc
	arq_15d_gfs=${path_gfs}/${a_aux}${m_aux}/${a_aux}${m_aux}${d_aux}/gfs.t${h_aux}z.pgrb2.0p50.${a_aux}${m_aux}${d_aux}${h_aux}.f123_f384.nc
	#
	...
	do  
	 ...
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/a2.nc > $path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 echo "Arquivo Gerado Horario tmp2m p/ 07 dias  -> "$path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/a3.nc > $path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 echo "Arquivo Gerado Diario tmp2m p/ 07 dias   -> "$path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/c2.nc > $path_out/prec_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 echo "Arquivo Gerado Horario prec p/ 07 dias  -> "$path_out/prec_hor_${cit}_${ai}${m_aux}${d_aux}${h_aux}_07d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/c3.nc > $path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 echo "Arquivo Gerado Diario prec p/ 07 dias   -> "$path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt
	 ...
	 do
	   ...
	   grep "${aa}-${mm}-${dd}" $path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt > ${path_cmp}/${aa}${mm}/f${fct}/tmp2m_gfs_hor_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt > ${path_cmp}/${aa}${mm}/f${fct}/tmp2m_gfs_day_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/prec_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt > ${path_cmp}/${aa}${mm}/f${fct}/prec_gfs_hor_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_07d.txt > ${path_cmp}/${aa}${mm}/f${fct}/prec_gfs_day_${cit}_f${fct}_${aa}${mm}${dd}.txt
	 ...
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/b2.nc > $path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 echo "Arquivo Gerado Horario tmp2m p/ 15 dias -> "$path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/b3.nc > $path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 echo "Arquivo Gerado Diario tmp2m p/ 15 dias   -> "$path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/d2.nc > $path_out/prec_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 echo "Arquivo Gerado Horario prec p/ 15 dias -> "$path_out/prec_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 #
	 cdo -outputtab,date,time,lon,lat,value -remapnn,"lon=${lon}_lat=${lat}" ${path_tmp}/d3.nc > $path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 echo "Arquivo Gerado Diario prec p/ 15 dias   -> "$path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt
	 ...
	 do
	   ...
	   mkdir -p ${path_cmp}/${aa}${mm}
	   mkdir -p ${path_cmp}/${aa}${mm}/f${fct}
	   grep "${aa}-${mm}-${dd}" $path_out/tmp2m_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt > ${path_cmp}/${aa}${mm}/f${fct}/tmp2m_gfs_hor_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/tmp2m_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt > ${path_cmp}/${aa}${mm}/f${fct}/tmp2m_gfs_day_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/prec_day_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt > ${path_cmp}/${aa}${mm}/f${fct}/prec_gfs_day_${cit}_f${fct}_${aa}${mm}${dd}.txt
	   grep "${aa}-${mm}-${dd}" $path_out/prec_hor_${cit}_${a_aux}${m_aux}${d_aux}${h_aux}_15d.txt > ${path_cmp}/${aa}${mm}/f${fct}/prec_gfs_hor_${cit}_f${fct}_${aa}${mm}${dd}.txt
